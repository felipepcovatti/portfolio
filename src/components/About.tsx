      ...
      <div className="container">
        <div className="row">
          <div className="col-12 col-md-10 col-lg-8 col-xl-6 mx-auto text-center">
            ...
            <p>I have a bachelor's degree in graphic design and 2+ years of work experience in the tech industry, part
              as a designer, and, most recently, as a junior frontend developer. <br />I am currently open to job
        ...
        <div className="row">
          <div className="col-12 col-md-6 text-center text-md-left">
            ...
            <p>Feel free to contact me at:<span className="sr-only">The email is displayed in SVG elements, for security
            reasons. If you would like to know the email and do not have access to it, you can easily form the email
            by adding "_p_covatti@g_mail.com" to the end of the word "felipe", without the quotation marks and
                without the underline characteres.</span> <span className="emailaddress text-primary">
          ...
          <div className="col text-center text-md-right about_more">
            <h2 className="text-muted">More</h2>
            <div>
              <a className="text-primary" href="https://www.linkedin.com/in/felipepcovatti" data-shorthref="linkedin.com/in/felipepcovatti" target="_blank">
                <span className="sr-only">linkedin.com/in/felipepcovatti</span>
                {/* <!-- svg base code from https://uxwing.com/linkedin-square-icon/ --> */}
                <svg className="" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd" imageRendering="optimizeQuality" shapeRendering="geometricPrecision" textRendering="geometricPrecision" viewBox="0 0 640 640">
                  <path d="M580 0H60C27 0 0 27 0 60v520c0 33 27 60 60 60h520c33 0 60-27 60-60V60c0-33-27-60-60-60zM240 520h-80V240h80v280zm-40-320a40 40 0 1 1 0-80 40 40 0 0 1 0 80zm320 320h-80V360a40 40 0 1 0-80 0v160h-80V240h80v49.6c16.5-22.6 41.8-49.6 70-49.6 49.8 0 90 44.8 90 100v180z"></path>
                </svg>
              </a>
            </div>
            <div>
              <a className="text-primary" href="https://github.com/felipepcovatti" data-shorthref="github.com/felipepcovatti" target="_blank">
                <span className="sr-only">github.com/felipepcovatti</span>
                {/* <!-- svg base code from https://uxwing.com/github-icon/ --> */}
                <svg className="" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd" imageRendering="optimizeQuality" shapeRendering="geometricPrecision" textRendering="geometricPrecision" viewBox="0 0 640 640">
                  <path d="M320 8a320 320 0 0 0-101.2 623.6c16 3 22-7 22-15.4 0-7.7-.4-32.9-.5-59.6-89 19.4-107.8-37.7-107.8-37.7-14.6-37-35.6-46.9-35.6-46.9-29-19.9 2.2-19.4 2.2-19.4 32.2 2.2 49 33 49 33 28.6 48.9 75 34.7 93.2 26.5 2.9-20.6 11.2-34.8 20.3-42.8-71-8-145.8-35.5-145.8-158.1a124 124 0 0 1 33-85.9c-3.3-8-14.3-40.6 3-84.7 0 0 27-8.6 88.1 32.8a307 307 0 0 1 160.2 0c61.1-41.4 88-32.8 88-32.8 17.3 44.1 6.4 76.7 3.1 84.7 20.5 22.4 33 51 33 85.9 0 122.9-75 150-146.2 157.8 11.5 10 21.7 29.4 21.7 59.3 0 42.8-.3 77.3-.3 87.8 0 8.5 5.7 18.5 22 15.3A320 320 0 0 0 320 8z"></path>
                </svg>
              </a>
            </div>
          </div>
